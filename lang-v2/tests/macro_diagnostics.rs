...
fn cfg_attr_gated_public_handlers_do_not_emit_missing_wrappers() {
    compile_pass_case(
        "cfg_attr_gated_handler",
        r#"
use anchor_lang_v2::prelude::*;
...
fn cfg_attr_disabled_members_are_omitted_from_idl_and_error_codes() {
    cargo_test_pass_case(
        "cfg_attr_filtered_idl",
        r#"
use anchor_lang_v2::prelude::*;
