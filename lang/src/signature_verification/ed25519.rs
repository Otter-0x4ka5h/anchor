...
/// Verifies an Ed25519 instruction whose signature, public key, and message are
/// embedded directly in the instruction data using Solana's default layout.
...
/// Verifies an Ed25519 instruction whose signature, public key, and message all
...
pub fn verify_ed25519_ix_with_instruction_index(
    ...
    let pubkey_offset: u16 = DATA_START as u16;
    let sig_offset: u16 = pubkey_offset + pubkey_len;
    let msg_offset: u16 = sig_offset + sig_len;
